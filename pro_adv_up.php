<?php include "templates/include/header_without_select.php" ?>
	...
	<section id="middle">
		...
		<div >
			...
			<center><div><p>
			<form id="place_order_form" action="pro_adv_update.php" onsubmit="checkfields();return false;" enctype="multipart/form-data" method="post">
				...
				<tbody>
					...
					<tr>							
						...
						<td ><input type="text" name="order_name" class="order_input" id="order_name" value="<?php echo $_GET['name']; ?>"></td>
					...
					<tr>							
						...
						<td ><input type="text" name="order_amount" class="order_input" id="order_amount" value="<?php echo $_GET['price']; ?>"></td>
					...
					<tr class="order_sel">
						...
						<td colspan=2><textarea name="order_descr" id="order_descr" ><?php echo $_GET['descr']; ?></textarea></td>
					</tr>
					<?php echo '<input name="id" type="hidden" value="'.$_GET['id'].'">'?>
					<tr>					
						<td class="label_r"></td>
						<td class="labl"></td>
						<td style="padding: 12px 7px;"><button class="but_r" type="submit" name="submit">сохранить изменения</button></td>
						<td  width="36%"></td>
					</tr>
					</tbody>
				</table>
